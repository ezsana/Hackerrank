...
class DayOfTheProgrammerTest {
    ...
    @Test
    public void yearIsLeapYearInGregorianCalendar() {
    ...
    @Test
    public void yearIsNormalInJulianCalendar() {
    ...
    @Test
    public void yearIsNormalInGregorianCalendar() {
